...
// zeshan commenting this firebase setup
// const firebaseConfig = {
//   apiKey: "AIzaSyBQJRcifxvbYAbrUDO-6s20UzaXKUPkVH8",
//   authDomain: "checking-aeaee.firebaseapp.com",
//   projectId: "checking-aeaee",
//   storageBucket: "checking-aeaee.appspot.com",
//   messagingSenderId: "842868411158",
//   appId: "1:842868411158:web:85c2960fe92f1102939e37",
//   measurementId: "G-FHFG60TPBG",
// };
...
onValue(candidateData, (snapshot) => {
  ...
  if (lastbidid < data.lastBid.id) {
    ...
    tbodydata +=
      '<td><a href="/admin/customers/' +
      data.lastBid.customerId +
      '" class="btn btn-primary btn-sm"> Customer Details</a></td >';
    tbodydata += "</tr>";
