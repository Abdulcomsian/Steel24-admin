@extends('seller.layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Steel24')])
...
<div class="container" style="height: auto;">
    <div class="row align-items-center">
        ...
        <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
            <form class="form" method="POST" action="{{ route('seller.login') }}">
                @csrf
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <a href="{{ route('seller.password.request') }}" class="text-light">
                        <small>{{ __('Forgot password?') }}</small>
                    </a>
                    @endif
                </div>
                <div class="col-6 text-right">
                    {{-- <a href="{{ route('seller.register') }}" class="text-light">
