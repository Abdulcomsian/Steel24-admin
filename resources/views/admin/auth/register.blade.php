@extends('admin.layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Steel24')])
        ...
        <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
            <form class="form" method="POST" action="{{ route('admin.register') }}">
                ...
                <div class="card card-login card-hidden mb-3">
                    ...
                    <div class="card-body ">
                        <p class="card-description text-center">{{ __('Register Your Self') }}</p>
            ...
            <div class="row">
                <div class="col-6">
                    <a href="" class="text-light">
                        <small><b>{{ __('Already Registered?') }}</b></small>
                    </a>
                </div>
                <div class="col-6 text-right">
                    <a href="{{ route('admin.login') }}" class="text-light">
                        <small><b>{{ __('Sign In') }}</b></small>
                    </a>
                </div>
            </div>
        </div>
