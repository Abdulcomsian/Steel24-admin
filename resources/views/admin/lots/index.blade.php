                                    ...
                                    <div class="row">
                                        <div class="col-12 text-right">
                                            ...
                                            <a href="{{ url('admin/users-send-email') }}"
                                                class="btn btn-info send_mail_button">Send Email</a>
                                            <a href="{{ url('admin/lots/create') }}" class="btn btn-primary add_New_Button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="mr-2" fill="currentColor" viewBox="0 0 16 16">
