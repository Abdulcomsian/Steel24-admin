                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ url('admin/addpayment_plan') }}" class="form-horizontal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="Price_Bases" name="Price_Bases" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="Texes_and_Duties" name="Texes_and_Duties" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="Commercial_Terms" name="Commercial_Terms" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="Test_Certificate" name="Test_Certificate" required>
                                    </div>
                                </div>
                            </div>
                            <!--End body-->
