            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <!--Body-->
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(url('admin/addpayment_plan')); ?>" class="form-horizontal">
                                <?php echo csrf_field(); ?>
                                <div class="form-row">
...
<?php echo $__env->make('admin.layouts.main', ['activePage' => 'Payment Plan', 'titlePage' => 'Payment Plan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Steel24-admin\resources\views/admin/lots/addLotsTerms.blade.php ENDPATH**/ ?>